      ...
      <section className={styles.content}>
        ...
        <div className={styles.block}>
          ...
          <p className={styles.text}>
            Varuna is an AI-powered knowledge assistant designed to help you
            ...
            Varuna brings together cutting-edge artificial intelligence with
            ...
            or an interested citizen. With Varuna, you can ask questions in
            natural language and receive intelligent, reliable, and
            easy-to-understand explanations backed by authoritative sources.{' '}
            <br />
            Varuna is <strong>free to use</strong> and built to encourage
            ...
            and public understanding, Varuna supports ICED’s mission to
        ...
        <div className={styles.block}>
          ...
          <p className={styles.text}>
            Varuna has been conceptualized and developed under the vision and
